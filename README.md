...
The expected supplier transaction price file needs to be manually uploaded into config S3 bucket (ENV_NAME-config-bucket) in the prices folder with name prices.csv
