...
describe("invoice handler", () => {
  ...
  test("Page displays Invoice above threshold banner text and three line items in the Reconciliation Table for Mar 2023", async () => {
    ...
    givenExtractResults = `{"vendor_id":"vendor_testvendor1","vendor_name":"Vendor One","service_name":"Passport check","month":"03","year":"2023","invoice_is_quarterly":false,"contract_id":"1","contract_name":"C01234","billing_price_formatted":"293.19","transaction_price_formatted":"266.82","price_difference":"26.37","billing_quantity":"73298", "transaction_quantity":"66706", "quantity_difference":"6,592.00","billing_amount_with_tax":"351.83","price_difference_percentage":"9.8814"}
    {"vendor_id":"vendor_testvendor1","vendor_name":"Vendor One","service_name":"Passport check","month":"03","year":"2023","invoice_is_quarterly":false,"contract_id":"1","contract_name":"C01234","billing_price_formatted":"3,850.16","transaction_price_formatted":"3,854.92","price_difference":"-4.76","billing_quantity":"11324", "transaction_quantity":"11338", "quantity_difference":"-14","billing_amount_with_tax":"4,620.19","price_difference_percentage":"-1.1235"}
    {"vendor_id":"vendor_testvendor1","vendor_name":"Vendor One","service_name":"Passport check","month":"03","year":"2023","invoice_is_quarterly":false,"contract_id":"1","contract_name":"C01234","billing_price_formatted":"100","transaction_price_formatted":"100","price_difference":"0.00","billing_quantity":"100", "transaction_quantity":"100", "quantity_difference":"100.00","billing_amount_with_tax":"110","price_difference_percentage":"0"}`;
  ...
  test.only("Page displays Invoice three line items in the Reconciliation Table for Q1 2023", async () => {
    mockedGetQuarterMonth.mockReturnValue(4);
    mockedIsQuarter.mockReturnValue(true);

    givenExtractResults = `{"vendor_id":"vendor_testvendor1","vendor_name":"Vendor One","service_name":"ABC Charge","month":"04","year":"2023","invoice_is_quarterly":"true","contract_id":"2","contract_name":"C01235","billing_price_formatted":"293.19","transaction_price_formatted":"266.82","price_difference":"26.37","billing_quantity":"73298", "transaction_quantity":"66706", "quantity_difference":"6,592.00","billing_amount_with_tax":"351.83","price_difference_percentage":"9.8814"}
    {"vendor_id":"vendor_testvendor1","vendor_name":"Vendor One","service_name":"ABC Charge","month":"04","year":"2023","invoice_is_quarterly":"true","contract_id":"2","contract_name":"C01235","billing_price_formatted":"3,850.16","transaction_price_formatted":"3,854.92","price_difference":"-4.76","billing_quantity":"11324", "transaction_quantity":"11338", "quantity_difference":"-14","billing_amount_with_tax":"4,620.19","price_difference_percentage":"-1.1235"}
    {"vendor_id":"vendor_testvendor1","vendor_name":"Vendor One","service_name":"ABC Charge","month":"04","year":"2023","invoice_is_quarterly":"true","contract_id":"2","contract_name":"C01235","billing_price_formatted":"100","transaction_price_formatted":"100","price_difference":"0.00","billing_quantity":"100", "transaction_quantity":"100", "quantity_difference":"100.00","billing_amount_with_tax":"110","price_difference_percentage":"0"}`;
    mockedFetchS3.mockResolvedValue(givenExtractResults);
