...
describe("\nUpload invoice to standardised folder and verify billing and transaction_curated view query results matches with expected data \n", () => {
  ...
  test.each`
    ...
    ${"BillingQty BillingPrice greater than TransactionQty and TransactionPice"}            | ${"EVENT_1"} | ${"client1"} | ${TimeStamps.CURRENT_TIME}        | ${"1"}             | ${"3.3300"}   | ${"1"}  | ${"100.0000"}          | ${"100"}             | ${"6.6600"}  | ${"2"}     | ${"3.3300"}      | ${"1"}
