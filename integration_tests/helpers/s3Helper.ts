...
import {ListBucketsCommandOutput,ListBucketsCommand, ListObjectsCommand, ListObjectsCommandInput} from "@aws-sdk/client-s3";
...
async function getBucketName() {
  ...
  const bucketName = bucketList.find(item => item.Name?.match("di-btm-storagebucket"))
   if(bucketName!=null) {
